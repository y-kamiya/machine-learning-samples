...
class DecoderRNN(nn.Module):
    ...
    def forward(self, input, hidden, _output):
...
class AttensionDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, dropout_p=0.1, max_length=10):
        super(AttensionDecoderRNN, self).__init__()
        self.hidden_size = hidden_size
    ...
    def forward(self, input, hidden, output):
        ...
        attn_applied = torch.bmm(attn_weights.unsqueeze(0), output.unsqueeze(0))
...
attn_decoder1 = AttensionDecoderRNN(hidden_size, output_lang.n_words, dropout_p=0.1).to(device)
