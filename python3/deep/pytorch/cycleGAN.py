...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambdaA', type=float, default=10.0, help='weight for cycle loss of A')
    parser.add_argument('--lambdaB', type=float, default=10.0, help='weight for cycle loss of B')
